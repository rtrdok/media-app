...
### Fixed / Исправлено
- Зависание «Не отвечает» при управлении окнами (мини-плеер больше не трогает HWND из HTTP-потока)
- Пустая страница «Настройки» — исправлены React hooks (useEffect после early return)

## [1.4.2] — 2026-09-13

### Fixed / Исправлено
- Мини-плеер: отдельное перемещаемое окно с громкостью и кнопкой закрытия (больше не «залипает» внутри приложения)
- Настройки «Основные»: выбранные значения языка / темы / акцента снова на русском
- Текст песни: синхронизация строк с воспроизведением (как в Spotify), клик по строке — переход
