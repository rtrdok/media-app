...
def build_extension_zip(port: int | None = None) -> bytes:
    ...
    with zipfile.ZipFile(buf, "w", compression=zipfile.ZIP_DEFLATED) as zf:
        ...
        zf.writestr(
            ...
            "Как пользоваться:\n"
            "• В попапе выбери тип / качество / формат один раз — сохраняется само\n"
            "• «Отправить в Media App» — текущая вкладка в очередь с этими правилами\n"
            "• ПКМ по ссылке / странице → «Отправить в Media App» (те же правила)\n"
